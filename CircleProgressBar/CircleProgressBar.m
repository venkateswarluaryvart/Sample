...
#define DefaultProgressBarProgressColor [UIColor colorWithRed:0.999 green:0 blue:0 alpha:0.7]
#define DefaultProgressBarTrackColor [UIColor colorWithRed:1 green:1 blue:1 alpha:1]
const CGFloat DefaultProgressBarWidth = 10.0f;
